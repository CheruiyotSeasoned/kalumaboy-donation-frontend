...
export const Hero = ({ onDonateClick }: HeroProps) => {
  ...
  useEffect(() => {
    if (videoPlaying || dialogOpen) {
      // Load TikTok embed script when video is set to play
        ...
        <div className="grid lg:grid-cols-[1.2fr,0.8fr] gap-8 lg:gap-12 items-center">
          ...
          <div className="animate-fade-in">
            <div className="inline-block px-4 py-2 bg-green-400/20 backdrop-blur-sm rounded-full border border-green-400/30 mb-4">
              <p className="text-green-300 text-sm font-semibold">🤝 Every Contribution Counts</p>
            </div>
  ...
  medical hardship. Together, we can bring healing, dignity, and strength to those who need it most. 
            ...
            <div className="grid grid-cols-3 gap-4 mt-8 pt-8 border-t border-white/20">
              <div>
                ...
                <div className="text-xs text-white/70">Transparent</div>
              </div>
              <div>
              ...
              <div>
                <div className="text-2xl font-bold text-emerald-400 mb-1">Direct</div>
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative w-[325px] h-[580px]">
                ...
                {!videoPlaying ? (
                  ...
                  >
                    ...
                    <div className="relative z-10 text-center">
                      ...
                      <p className="text-white font-semibold text-base">Watch Vincent's Story</p>
                      <p className="text-white/70 text-sm mt-2">See the impact firsthand</p>
                    </div>
                  </div>
                ) : (
                  // TikTok embed
              ...
              {/* Floating badges */}
              <div className="absolute -top-3 -right-3 bg-green-500 text-white px-3 py-1.5 rounded-full font-bold text-xs shadow-xl animate-bounce">
                ❤️ Verified
              </div>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="sm:max-w-[425px] bg-gray-900/95 backdrop-blur-xl border-2 border-green-500/30">
          <DialogHeader>
            <DialogTitle className="text-white text-xl font-bold">Vincent's Story</DialogTitle>
          </DialogHeader>
          <div className="mt-4">
